...
//! другая точка в конце, «ещё/еще», словечко-паразит в начале. Число в конце
//! осталось только на «сильной» — и без решётки: цифры через пробел живая
//! переписка терпит, «#293508» — нет.
//!
