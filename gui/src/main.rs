...
//! общая папка со старой JS-версией продолжали работать.
...
///      запуск из `target/release` внутри проекта и общая папка с JS-версией;
...
mod tests {
    ...
    /// и переезжать они никуда не должны — их делят с JS-версией.
    #[test]
